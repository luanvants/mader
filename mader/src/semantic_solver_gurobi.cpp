...
SolverGurobi::SolverGurobi(ms::par_solver &par)
{
  ...
  semanticAstarSolver_ = new SemanticAstar(par_.basis, par_.num_pol, par_.deg_pol, par_.alpha_shrink);
}
...
{
  return semanticAstarSolver_->getNumOfLPsRun();
}
...
//
void SolverGurobi::setAttRegion(std::pair<Eigen::Vector3d, std::vector<Eigen::Vector3i>> &att_region) {
  // att_region_ = att_region;
  // std::cout << "att_region_ = " << att_region_.first.transpose() << std::endl;
  // std::cout << "att_region_ = " << att_region_.second[0].transpose() << std::endl;
  // std::cout << "att_region_ = " << att_region_.second[1].transpose() << std::endl;
  // std::cout << "att_region_ = " << att_region_.second[2].transpose() << std::endl;
}
//////////////////////////////////////////////////////////
